...
<!--======== Page Title and Breadcrumbs Start ========-->
        <div class="top-page-header" style="background-image: linear-gradient(0deg, #e5ffde 0%, #B5FFFC 100%);">
            ...
            <div class="page-breadcrumb">
                <nav class="c_breadcrumbs">
                    <ul>
                        <li><a href="#">home</a></li>
                        <li class="active"><a href="#">Sholat Ashar</a></li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="row" >
            ...
            <div class="col-md-12">
                <div class="c_panel" style="background-image: linear-gradient(0deg, #e5ffde 0%, #B5FFFC 100%);">
                    <div class="c_title">
                        <h1><strong>Sholat Ashar</strong></h1>
                    ...
                    <div class="c_content">
                        <form action="" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="nama_sholat" id="sholat" value="ashar">
                            <input type="hidden" name="star" id="star" value="">
                            <input type="hidden" name="waktu_sholat" id="waktu_sholat" value="{{ $schedule['ashar']}}">
                            @include('siswa.emoji')
