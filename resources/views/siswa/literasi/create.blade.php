                        ...
                        <div class="c_content">
                            <form class="form-horizontal" id="formLiterasi" name="formLiterasi" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input class=" form-control" name="halaman" type="text" required />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group ">
                                            <label for="cname" class="control-label col-sm-4">Paragraf</label>
                                            <div class="col-sm-8">
                                                <input class=" form-control" name="p_awal" type="text" required placeholder="Paragraf Awal"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group ">
                                            <label for="cname" class="control-label col-sm-2">Sampai</label>
                                            <div class="col-sm-10">
                                                <input class=" form-control" name="p_akhir" type="text" required placeholder="Paragraf Akhir"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        $("#formLiterasi").validate({
            submitHandler: function (form) {
                $.ajax({
                    ...
                    url: "{{ route('literasi.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        window.location.href = "{{ route('literasi.index') }}";
                    },
                    error: function (data) {
