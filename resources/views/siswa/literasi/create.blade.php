...
@section('content')
    ...
    <div class="top-page-header" style="background: linear-gradient(90deg, #00C9FF 0%, #92FE9D 100%);">

        <div class="page-title">
            <h2>Sudah Membaca Hari Ini</h2>
            <small>Jangan lupa membaca karena dengan membaca bikin ilmu pengetahuan kita luas seluas alam semseta</small>
        </div>
        <div class="page-breadcrumb">
            <nav class="c_breadcrumbs">
                <ul>
                    <li><a href="#">home</a></li>
                    <li class="active"><a href="#">Literasi</a></li>
                </ul>
            </nav>
        </div>
                        ...
                        <div class="c_content">
                            <form class="form-horizontal" id="formLiterasi" name="formLiterasi" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class=" form-control input-lg" name="jumlah_paragraf" id="jumlah_paragraf" type="text" required />
                                    </div>
                                </div>
...
if (startButton) {
    ...
    div_vidio.style.display = "block";
        ...
        .then(recordedChunks => {
            ...
            var jumlah_paragraf = $('#jumlah_paragraf').val();
            var star = $('#star').val();
            ...
            formData.append('jumlah_paragraf', jumlah_paragraf);
