                        ...
                        <li class="sidebar-profile">
                            ...
                            <div class="profile-main">
                                ...
                                <p>
                                    ...
                                    <span class="position" style="font-family: monospace;">Orang Tua Siswa SD-TELKOM</span>
                                </p>
                            </div>

                        </li>
                        <li class='{{ route('ortu.home') }}'><a href="#" class="hvr-bounce-to-right-sidebar-parent active"><span class='icon-sidebar icon-home fa-2x'></span><span>Profile</span></a></li>

                        <li><a href="{{ route('ortu-anak.index') }}" class="hvr-bounce-to-right-sidebar-parent">
